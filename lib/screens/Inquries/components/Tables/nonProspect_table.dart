...
class NonProspectTable extends StatefulWidget {
  ...
  const NonProspectTable({Key? key, required this.inquiries}) : super(key: key);
    ...
    return widget.inquiries.isEmpty
        ...
        : SingleChildScrollView(
            child: Column(
              children: [
                PaginatedDataTable(
                  header: const Text('Non Prospect Inquiries'),
                  columns: const [
                  ...
                  source: _NonProspectTableDataSource(widget.inquiries),
...
class _NonProspectTableDataSource extends DataTableSource {
  ...
  _NonProspectTableDataSource(this.inquiries);
