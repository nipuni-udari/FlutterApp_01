                ...
                <div class="row g-0 h-100">
                  ...
                  <div class="col-md-12 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="text-center"><img class="me-2" src="assets/img/main.png" alt="" width="100" />
             <br><hr>
                        <h3>See you again!</h3>
                        <p>Thanks for using IAssit. You are <br />now successfully signed out.</p><a class="btn btn-primary btn-sm mt-3" href="login.php"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to Login</a>
                      </div>
                    </div>
                  </div>
                </div>
